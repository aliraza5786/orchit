      ...
      <div class="mx-auto flex max-w-[1400px] items-center justify-between px-6 ">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="relative" ref="menuRef">
            <button
              class="h-9 w-9 overflow-hidden rounded-full bg-orange-500 text-sm font-bold text-text-primary ring-offset-2 transition
            ...
            >
              ...
              >
                ...
                <div class="flex items-center gap-3 rounded-xl p-3">
                  <div class="grid h-11 w-11 place-items-center rounded-full bg-orange-500 text-base font-bold text-text-primary">
                    {{ initials }}
                  </div>
                  <div class="min-w-0">
                ...
                <ul class="p-1">
                  <li>
                    <RouterLink
                      to="/profile"
                      class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-bg-dropdown-menu-hover"
                      role="menuitem"
                      @click="closeMenu"
                    >
                  ...
                  <li class="relative" @mouseenter="openTheme()" @mouseleave="closeTheme()">
                    ...
                    >
                      ...
                      >
                        <button
                          class="block w-full rounded-lg px-3 py-2 text-left hover:bg-bg-dropdown-menu-hover"
