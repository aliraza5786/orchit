<template>
  ...
  <div class="relative inline-block text-left" ref="dropdownRef">
    <!-- Trigger -->
    <a href="#" :class="[
      'hover:text-text-primary text-nowrap text-[13px] !font-normal overflow-hidden relative hover:bg-bg-card  group rounded-lg transition-all duration-75 text-primary flex gap-1.5 items-center px-2 py-1.5',
      isOpen || selected ? 'bg-bg-card text-text-primary  ' : 'text-text-secondary'
    ]">
