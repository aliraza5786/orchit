<template>
  ...
  >
    ...
    <div class="flex sm:gap-2 min-w-max items-center">
      <button class="bg-gradient-to-tr from-accent to-accent-hover cursor-pointer text-white flex items-center h-8 gap-2 px-3 py-1 rounded-[6px] text-xs font-medium transition-all hover:shadow-lg hover:shadow-accent/20 text-nowrap" @click="workspaceStore.toggleChatBotPanel()" v-tooltip="'Ask any question'">
