<template>
  <Transition name="panel" appear v-if="showPanel">
    <div
      class="w-full"
    >
      <div
      ...
      <div v-else>
        ...
        >
          <h5 class="text-[18px] font-semibold tracking-tight">Ticket Details</h5>
                ...
                >
                  ...
                  >
                    ...
                    <AssigmentDropdown
                      ...
                      @assign="(users:any) => handleVariableUpdate(users, item.slug)"
                    />
...
const DatePicker = defineAsyncComponent(() => import("../../../views/Product/components/DatePicker.vue"));
const TimePicker = defineAsyncComponent(() => import("../../../views/Product/components/TimePicker.vue"));
const AssigmentDropdown = defineAsyncComponent(
  () => import("../../../views/Product/components/AssigmentDropdown.vue"),
);
