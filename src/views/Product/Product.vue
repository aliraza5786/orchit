  ...
  >
    ...
    >
      ...
      <div class="flex gap-3 items-center">
        <button
            v-if="view === 'mindmap'"
            @click="openDefaultFormatSidebar"
            class="aspect-square cursor-pointer rounded-sm bg-gray-100 p-1"
            :class="
              view === 'mindmap'
...
function openDefaultFormatSidebar() {
  selectedMindNode.value = null;
