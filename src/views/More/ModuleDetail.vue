...
import { useCreateComment, useModuleDetail, useModuleLists, useUseModule } from '../../queries/useMore';
...
const useModuleHandler = () => {
  useModule({
    payload: {
      workspace_id: workspaceId.value, module_id: moduleDetail?.value?._id
    }
  })
}
</script>
