<template>
  <div class="w-full pt-4">
    <h2 v-once class="text-xl md:text-4xl font-semibold text-text-primary text-left">Project Details</h2>
    <p v-once class="text-sm md:text-lg text-text-secondary text-left mt-2 mb-6">Let's refine your project details</p>
  </div>

  <div class="space-y-6 pb-4 w-full h-[470px]">
